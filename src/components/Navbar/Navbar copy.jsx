...
function Navbar(props) {
  ...
  const navbarClasses = `p-4 fixed w-full top-0 left-0 ${navbarBackgroundColor} ${navbarTextColor} flex justify-between items-center ${navbarLayoutClasses}`;
            ...
            {sidebarVisible && windowWidth < 1080 ? (
              ...
              <div className="flex items-center">
                <NavLink
                  to="/"
                  exact
                  className={`text-2xl ${linkTextStyles} ${linkSpacing}`}
                  activeClassName={isDarkMode ? activeLinkDarkMode : activeLinkLightMode}
                ...
                <div className={`text-2xl ${linkTextStyles} p-2 rounded ${isDarkMode ? null : 'bg-brown-200'}`}>
                  <span
